...
| 0017 | [COVERAGE_LOCKED payload contract + coverage vocabulary](0017-coverage-locked-payload-contract.md) | Accepted | [schemas/events.py](../../services/visionaudioforge/app/schemas/events.py) — pins `defensive_coverage` on `FootballPayload` |
...
| 0019 | [Live-feed HUD recalibration (v2.3.0-live) + broadcast-bar glyph-OCR limit](0019-live-feed-hud-recal-and-glyph-ocr-limit.md) | Accepted | supersedes `hud_regions.json` v2.2.0 → v2.3.0-live; banks the digit-OCR pass |
