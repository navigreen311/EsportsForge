...
export default function PlayDetail({
  ...
  return (
    <Card padding="lg" className="space-y-5">
      ...
      {/* Inline animated play diagram (AnimatedPlayDiagram) intentionally removed
          from the gameplan surface — parked with the play-art / play-diagram idea.
          The component + route plumbing remain; re-mount here to bring it back. */}
